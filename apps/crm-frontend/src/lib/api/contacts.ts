...
export async function getContact(id: string, organizationId: string): Promise<Contact> {
...
export async function deleteContact(id: string, organizationId: string): Promise<void> {
