...
export async function getCompany(id: string, organizationId: string): Promise<Company> {
...
export async function deleteCompany(id: string, organizationId: string): Promise<void> {
