...
const en = {
  ...
  activities: {
    ...
    deleteConfirmDesc:
      'This action cannot be undone. The activity and all associated data will be permanently removed.',
  ...
  users: {
    ...
    deleteConfirmDesc:
      'This action cannot be undone. The user account for {name} will be permanently deactivated.',
